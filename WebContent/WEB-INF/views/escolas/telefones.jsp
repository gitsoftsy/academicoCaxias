		...
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-school fa-lg"></i> <span>Telefones</span>
				</div>
			</div>
		</section>
						...
						<form id="formCadastro">
							...
							<div class="mb-4">
								<label for="descricao" class="form-label">Descrição:<span
									class="red">*</span></label> <input type="text" id="descricao" required
									autocomplete="off" name="descricao" class="form-control" />
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formEdit">
							...
							<div class="mb-4">
								<label for="descricao" class="form-label">Descrição:<span
									class="red">*</span></label> <input type="text" id="descricaoEdit" required
									autocomplete="off" name="descricao" class="form-control" />
							</div>
