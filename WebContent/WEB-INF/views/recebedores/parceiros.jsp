...
<body>
	...
	<main class="py-4 container-res">
		<section class="mb-5">
			<div class="card">
				<div class="card-body title">
					<i class="fa-solid fa-graduation-cap fa-lg"></i> <span>Parceiros</span>
				</div>
			</div>
		</section>
		<section class="pt-4 card card-table px-5 py-3">
			...
			<div class="row mb-3">
				<div class="col-md-4">
					<label for="documentoSearch" class="form-label">Documento:<span
						class="red">*</span></label> <input type="text" class="form-control mb-3 searchInput"
						placeholder="Digite o CPF ou CNPJ" id="documentoSearch" name="documentoSearch"/>
				</div>
				<div class="col-md-4">
					<label for="nomeSearch" class="form-label">Nome do
						Parceiro:<span class="red">*</span>
					</label> <input type="text" class="form-control mb-3 searchInput"
						placeholder="Digite o nome do parceiro" id="nomeSearch" name="nomeSearch"/>
				</div>
			...
			<div id="messageInfo" class="d-flex justify-content-center">
				<h3>Preencha ao menos um filtro para continuar.</h3>
			</div>
						...
						<tr>
							<th scope="col" class="sortable border-end"
								...
								<div
									...
									<div
										...
										<span>Tipo</span> <i class="fas fa-sort me-3"
							...
							<th scope="col" class="sortable border-end"
								...
								<div
									...
									<div
										class="col d-flex align-items-center justify-content-between">
										<span>Documento</span> <i class="fas fa-sort me-3"
											style="color: #dddddd"></i>
									</div>
									<div class="dropdown-form">
							...
							<th scope="col" class="sortable border-end"
								...
								<div
									...
									<div
										class="col d-flex align-items-center justify-content-between">
										<span>Status</span> <i class="fas fa-sort me-3"
											style="color: #dddddd"></i>
									</div>
									<div class="dropdown-form">
										<div class="dropdown-toggle-form" id="dropdownButton4">
	...
	<script charset="UTF-8"
		src="<%=contextPath%>/resources/assets/js/recebedores/parceiros.js"></script>
	<script charset="UTF-8"
