  ...
  <body>
    ...
    <main class="py-4 container-res">
      <section class="mb-5">
        <div class="card">
          <div class="card-body title">
            ...
            ><span id="span-title">Matricula</span>
          </div>
        </div>
      </section>
      ...
      <section id="containerInfoTurma" class="mb-3">
        <div class="card p-3">
          <div class="title mb-3">
            <i class="fa-solid fa-people-roof" style="font-size: 24px"></i>
      ...
      <section class="pt-4">
        ...
        >
          <h3 id="tituloForm" class="text-start mt-3 mb-5">
            Selecione os alunos
          </h3>
          ...
          <div class="col-md-6">
            <label for="tipoMatriculaId" class="form-label"
              >Tipo Matricula:<span class="red">*</span></label
            >
            <select
              class="form-select"
              aria-label="tipoMatriculaId"
              id="tipoMatriculaId"
              required
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/matrizCurricular/matricula.js"
    ></script>
