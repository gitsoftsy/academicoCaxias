...
<html>
  ...
  <body>
    ...
    <main class="py-4 container-res">
      ...
      <section id="containerInfoAluno" class="mb-5">
        <div class="card p-3">
          ...
          <div class="row matrmb-3">
            <div class="col">
              <label for="obsAprovacao" class="form-label">Matricula: </label>
              <input
                type="text"
                id="matricula"
                autocomplete="off"
            ...
            <div class="col">
              <label for="obsAprovacao" class="form-label">Nome: </label>
              <input
                type="text"
                id="nomeAluno"
                autocomplete="off"
            ...
            <div class="col-md-1 col align-self-end">
              <button
                class="btn btn-primary w-100 px-3"
                onclick="verAvisosAluno()"
              >
      ...
      >
        <nav>
          <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
            <button
              ...
              id="nav-dados-pessoais-tab"
              data-bs-toggle="tab"
              data-bs-target="#nav-dados-pessoais"
              type="button"
              role="tab"
              aria-controls="nav-dados-pessoais"
              aria-selected="true"
            >
              Dados Pessoais
            </button>
            <button
              ...
              id="nav-acad-tab"
              data-bs-toggle="tab"
              data-bs-target="#nav-acad"
              type="button"
              role="tab"
              aria-controls="nav-acad"
              aria-selected="false"
            >
              Dados Acadêmicos
            </button>
        ...
        <div class="tab-content" id="nav-tabContent">
          <div
            class="tab-pane fade show active mb-4"
            id="nav-dados-pessoais"
            role="tabpanel"
          ...
          >
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <label for="nomeSocial" class="form-label"
                  >Nome Social:<span class="red">*</span>
                </label>
                <input
                  type="text"
                  id="nomeSocial"
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <label for="ufNascimentoId" class="form-label"
                  >UF de Nascimento:
                </label>
                <select
                  class="form-select"
            ...
            <div id="certidaoNascimento" class="mt-5">
              <h2 id="titulonNascimento" class="mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <label
                    for="certidaoNascimentoCidadeCartorio"
                    class="form-label"
                    >Cidade do cartório:</label
                  >
                  <select
                    class="form-select"
                    aria-label="Certidão de Nascimento UF Cartório"
            ...
            <div id="certidaoCasamento" class="mt-5">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <label
                    for="certidaoCasamentoCidadeCartorioId"
                    class="form-label"
                    >UF do cartório:</label
                  >
                  <select
          ...
          <div
            ...
            id="nav-det-ficha"
            role="tabpanel"
            aria-labelledby="nav-det-ficha-tab"
            tabindex="0"
          >
            <div class="d-flex align-items-center justify-content-between">
          ...
          >
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <label for="escolaId" class="form-label">Escola: </label>
                <select
                  class="form-select"
                  aria-label="Escola"
                  id="escolaId"
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <label for="serieId" class="form-label">Série: </label>
                <select
                  class="form-select"
                  aria-label="Serie"
                  id="serieId"
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <label for="situacaoAlunoId" class="form-label"
                  >Situação Aluno:
                </label>
                <select
                  class="form-select"
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/matrizCurricular/dadosAluno.js"
    ></script>
