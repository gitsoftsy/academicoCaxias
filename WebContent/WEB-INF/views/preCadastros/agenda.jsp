  ...
  <body>
    ...
    <main class="py-4 container-res">
      ...
      <section class="pt-4 card px-5 py-3 mb-4">
        ...
        <form id="formGetTurma">
          <div class="row">
            <div class="col-md-4 mb-3">
              <label for="periodoLetivo" class="form-label"
                >Período Letivo<span class="text-danger">*</span>
              </label>
        ...
        <hr />
        <div
          class="w-100 my-5 d-flex align-items-center justify-content-center"
          style="flex: 1"
        >
          <h2 id="textoInicial">
            Selecione os filtros para a realizar a busca.
          </h2>
        </div>
      ...
      <section class="pt-4 card px-5 py-3" id="containerAnexos">
        ...
        >
          ...
          <div class="d-flex align-items-center gap-2">
            ...
            <button
              class="btn btn-primary btn-sm btn-new-alter px-3 py-1 ms-auto"
              data-bs-toggle="modal"
              onclick="showModalAnexo()"
              data-bs-target="#newCadastroAnexo"
            >
              Novo Cadastro
            </button>
          </div>
        ...
        <div class="container-table contTable pt-4">
          ...
          >
            ...
            <tbody id="cola-tabela-anexo" class="table-group-divider"></tbody>
          </table>
        </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form id="formCadastroAnexo">
                  <div class="col-md-12">
                    <div class="mb-4">
                      <label for="agendaIdAnexo" class="form-label"
                        >Agenda:<span class="red">*</span> </label
                      ><select
                        class="form-control"
                  ...
                  <div class="col-md-12">
                    <div class="mb-4">
                      ...
                      <input
                        autocomplete="off"
                        type="text"
                        id="descricaoAnexoAgenda"
                        name="descricaoAnexoAgenda"
                        class="form-control"
                      />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="mb-4">
                      <label for="anexoAgenda" class="form-label"
                        >Arquivo:<span class="red">*</span> </label
                      ><input
                        autocomplete="off"
                        type="file"
                        id="anexoAgenda"
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form id="formEditAnexo">
                  <div class="col-md-12">
                    <div class="mb-4">
                      <label for="agendaIdAnexoEdit" class="form-label"
                        >Agenda:<span class="red">*</span> </label
                      ><select
                        class="form-control"
                        aria-label="Agenda Id"
                        id="agendaIdAnexoEdit"
                        name="agendaIdEdit"
                        disabled
                      >
                        <option selected disabled value="">
                  ...
                  <div class="col-md-12">
                    <div class="mb-4">
                      <label for="descricaoAnexoAgendaEdit" class="form-label"
                        >Descrição:
                      </label>
                      <input
                        autocomplete="off"
                        type="text"
                        id="descricaoAnexoAgendaEdit"
                        name="descricaoAnexoAgendaEdit"
                        class="form-control"
                      />
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="mb-4">
                      <label for="anexoAgendaEdit" class="form-label"
                        >Arquivo:<span class="red">*</span> </label
                      ><input
                        autocomplete="off"
                        type="file"
                        id="anexoAgendaEdit"
                        name="anexoAgendaEdit"
                        class="form-control"
                        required
                      />
                    </div>
            ...
            <div class="modal-body">
              <form id="formCadastro">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-4">
                      <label for="dataAgenda" class="form-label"
                        >Data Agenda:<span class="red">*</span> </label
                      ><input
                        autocomplete="off"
                        type="date"
                        id="dataAgenda"
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <label for="tituloAula" class="form-label"
                        >Titulo Aula: </label
                      ><input
                        autocomplete="off"
                        type="text"
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <label for="horaIni" class="form-label"
                        >Hora Início:<span class="red">*</span> </label
                      ><input
                        autocomplete="off"
                        type="time"
                        id="horaIni"
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <label for="horaFim" class="form-label"
                        >Hora Fim:<span class="red">*</span> </label
                      ><input
                        autocomplete="off"
                        type="time"
                        id="horaFim"
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <label for="turmaId" class="form-label"
                        >Realizada:<span class="red">*</span>
                      </label>
                      <div class="form-control card-form-infra">
                        <label for="isRealizada">Sim</label>
                        <label class="switch">
                          <input
                            type="checkbox"
                            id="isRealizada"
                        ...
                        <label for="isRealizada">Não</label>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-4">
                      <label for="dataAgendaEdit" class="form-label"
                        >Data Agenda:<span class="red">*</span> </label
                      ><input
                        autocomplete="off"
                        type="date"
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <label for="tituloAulaEdit" class="form-label"
                        >Titulo Aula: </label
                      ><input
                        autocomplete="off"
                        type="text"
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-4">
                      <label for="horaIniEdit" class="form-label"
                        >Hora Início:<span class="red">*</span> </label
                      ><input
                        autocomplete="off"
                        type="time"
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-4">
                      <label for="resumoEdit" class="form-label">Resumo: </label
                      ><input
                        autocomplete="off"
                        type="text"
                        id="resumoEdit"
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      ...
                      <div class="form-control card-form-infra">
                        <label for="isRealizadaEdit">Sim</label>
                        <label class="switch">
                          <input
                            type="checkbox"
                            id="isRealizadaEdit"
                            name="isRealizadaEdit"
                          />
                          <span class="slider"></span>
                        </label>
                        <label for="isRealizadaEdit">Não</label>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastroAnexo">
                <div class="col-md-12">
                  <div class="mb-4">
                    <label for="agendaId" class="form-label"
                      >Agenda:<span class="red">*</span> </label
                    ><select
                      class="form-control"
                      aria-label="Agenda Id"
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/agenda.js"
    ></script>
    <script
      charset="UTF-8"
