...
https://kit.fontawesome.com/3ce21ff22c.js"
  ...
  <body>
    ...
    <main class="py-4 container-res">
      ...
      <section id="containerInfoAluno" class="mb-5">
        <div class="card p-3">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              <label for="obsAprovacao" class="form-label">Email: </label>
              <input
                type="text"
                id="emailAluno"
                autocomplete="off"
            ...
            <div class="col-md-6">
              <label for="obsAprovacao" class="form-label">Curso: </label>
              <input
                type="text"
                id="cursoAluno"
                autocomplete="off"
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="title-edit">
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/avisos/listarAvisos.js"
    ></script>
