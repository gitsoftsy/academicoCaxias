...
<html>
  ...
  <body>
      ...
      <section class="mb-5">
        <div class="card">
          <div class="card-body title">
            <i class="fa-solid fa-school fa-lg"></i> <span>Dias da Semana</span>
          </div>
        </div>
      </section>
              ...
              <th scope="col" class="sortable border-end" data-column="horaFim">
                ...
                >
                  <div
                    class="col d-flex align-items-center justify-content-between"
                  >
                    <span>Permite Choque Horário</span>
                    <i class="fas fa-sort me-3" style="color: #dddddd"></i>
                  </div>
                </div>
              </th>
              <th scope="col" class="border-end pe-2 th-sem-filtro">Status</th>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formCadastro">
                ...
                <div class="mb-4">
                  <div class="col-md-12">
                    <label for="chequeHorario" class="form-label"
                      >Obrigatprio:<span class="red">*</span>
                    </label>
                    <div class="form-control card-form-infra">
                      <label for="choqueHorario">Sim</label>
                      <label class="switch">
                        <input
                          type="checkbox"
                          id="choqueHorario"
            ...
            <div class="modal-body">
              <form id="formEdit">
                ...
                <div class="mb-4">
                  <div class="col-md-12">
                    <label for="chequeHorario" class="form-label"
                      >Permite Choque Horário:<span class="red">*</span>
                    </label>
                    <div class="form-control card-form-infra">
                      <label for="permiteChoqueHorarioEdit">Sim</label>
                      <label class="switch">
                        <input
                          type="checkbox"
                          id="permiteChoqueHorarioEdit"
                          name="permiteChoqueHorarioEdit"
                        />
                        <span class="slider"></span>
                      </label>
                      <label for="permiteChoqueHorarioEdit">Não</label>
                    </div>
                  </div>
                </div>
                <div class="d-flex justify-content-end gap-2">
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/turmas/diasSemana.js"
    ></script>
    <script
      charset="UTF-8"
