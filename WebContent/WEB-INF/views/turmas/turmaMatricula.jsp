...
https://kit.fontawesome.com/3ce21ff22c.js"
  ...
  <body>
      ...
      <section id="containerInfoAluno" class="mb-5">
        <div class="card p-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              <label for="obsAprovacao" class="form-label">Turno: </label>
              <input
                type="text"
                id="turno"
                autocomplete="off"
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6 d-flex align-items-center mt-4">
              <a class="btn btn-primary btn btn-new-alter" id="btnMatricular"
                >Matricular Novos Alunos</a
              >
            </div>
          </div>
        </div>
    ...
    <script
      charset="UTF-8"
      src="<%=contextPath%>/resources/assets/js/turmas/turmaMatricula.js"
    ></script>
